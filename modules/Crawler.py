...
def crawl(url):
    ...
    if html is None:
        ...
        try:
            ...
            return {'url': url, 'links': links, 'meta': meta, 'title': title, 'documents': documents, 'contacts': contacts, 'images': images, 'videos': videos, 'audios': audios, 'headings': headings, 'text': text}
